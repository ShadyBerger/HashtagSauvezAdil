 ...
 */
    public static function ajout_css_js()
    {
        ...
        wp_enqueue_style('coding-theme', get_template_directory_uri() . '/css/shadyTheme.css');
        ...
        wp_enqueue_script('creative', get_template_directory_uri() . '/js/creative.js', ['jquery-perso'], null, true);
        }
};  
