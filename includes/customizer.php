...
class MgCustomizer
{
  ...
  // https://developer.wordpress.org/reference/classes/wp_customize_manager/add_control/
    ...
    $wp_customize->add_panel('shadyColorPanel', [
      'title' =>  __('Color Picker'),
    ]);
      $wp_customize->add_section('shadyColorSection', [
        'panel' =>  'shadyColorPanel',
        'title' =>  __('Color Picker'),
        'description' =>  __('Pick Your Color'),
      ]);
      $wp_customize->add_setting('bannerColor', [
        'default' => '#8224e3',
        'type' => 'theme_mod',
      ]);
       $wp_customize->add_control( 
         ...
         'link_color', 
         [
           'label'      => __( 'Navbar color', 'shadyTheme' ),
           'section'    => 'shadyColorSection',
